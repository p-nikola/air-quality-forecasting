...
KAFKA_GROUP_ID = os.getenv("SKOPJE_FORECAST_DB_GROUP_ID", f"skopje_forecast_db_consumer_cacko")
...
TOPIC_METADATA = {
    os.getenv("SKOPJE_PM10_TOPIC", "SkopjeFullPm10WeatherData"): (
        "pm10",
        "chronos2_pm10_skopje_fine_tuned_24h",
    ),
    os.getenv("SKOPJE_PM25_TOPIC", "SkopjeFullPm25WeatherData"): (
        "pm25",
        "chronos2_pm25_skopje_fine_tuned_24h",
    ),
    os.getenv("SKOPJE_PM10_ZERO_SHOT_TOPIC", "SkopjeFullPm10WeatherData_ZeroShot"): (
        "pm10",
        "chronos2_pm10_skopje_zero_shot_24h",
    ),
    os.getenv("SKOPJE_PM25_ZERO_SHOT_TOPIC", "SkopjeFullPm25WeatherData_ZeroShot"): (
        "pm25",
...
def main():
    ...
    print(f"Consuming Skopje forecast topics: {', '.join(topics)}")
